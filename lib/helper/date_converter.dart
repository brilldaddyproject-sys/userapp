...
class DateConverter {
  ...
  static String localDateAndTime(String date) {
    DateTime dateTime = DateTime.parse(date);
    String formatted = DateFormat('dd MMMM yyyy hh:mm:ss a').format(dateTime);
    return formatted;
  }
  ...
  static String dateTimeStringToDateAndTime(String dateTime) {
    return DateFormat('hh:mm a, dd MMM yyyy').format(DateFormat('yyyy-MM-dd HH:mm:ss').parse(dateTime));
  }
