                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisSize: MainAxisSize.min, children: [
                            ...
                            Row(children: [
                              ...
                              && !Provider.of<CheckoutController>(context, listen: false).isBrillDaddyWallet)
                                    ...
                                    return  Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          border: Border.all(color: Theme.of(context).primaryColor, width: 1), // Border color & width
