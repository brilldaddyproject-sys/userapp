...
class ReferHintView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> earnHintList = ["Your Friend Gets: 5% off on their 1st purchase","You Get: 5% commission on each successful referral, once your friend completes registration and makes their 1st purchase"];
    ...
    return Center(child: Container(decoration: BoxDecoration(
        ...
        child: Container(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
          ...
          child: Column(children: [
            ...
            Column(children: earnHintList.map((hint) => Row(children: [
