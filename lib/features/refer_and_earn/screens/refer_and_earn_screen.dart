...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> hintList = ["Refer your friends using your unique referral link or code.",
    "Your friend signs up and completes their registration.",
    "Your friend makes their 1st purchase.","You earn 5% commission on the purchase amount."];
    return Scaffold(
              ...
              SingleChildScrollView(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: shareItem.map((item) => GestureDetector(
                        onTap: () => Share.share("Thank you for being a valued customer! We're excited to offer you our referral program,We're glad you're part of our community! Refer your friends and earn rewards. Your referral code: "+ "${Provider.of<ProfileController>(context, listen: false).userInfoModel?.referCode??''}"),
