...
class Order {
  ...
  double? brilldaddyWalletDiscount;

  Order({this.isShippingFree, this.sellerIs, this.status,this.referralDiscount,this.brilldaddyWalletDiscount});
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    referralDiscount = json['referral_discount'].toDouble();
    brilldaddyWalletDiscount = json['brilldaddywallet_discount'].toDouble();
  }
