          ...
          builder: (context, config, _) {
            ...
            Consumer<OrderDetailsController>(
              builder: (context, orderProvider, child) {
                ...
                double brillDaddyWalletDiscount = 0;
                ...
                if (orderProvider.orderDetails != null && orderProvider.orderDetails!.isNotEmpty) {
                  ...
                  for (var orderDetails in orderProvider.orderDetails!) {
                    ...
                    referDiscount =  orderDetails.order!.referralDiscount!.toDouble();
                    brillDaddyWalletDiscount = orderDetails.order!.brilldaddyWalletDiscount!.toDouble();
                ...
                ListView(padding: const EdgeInsets.all(0), children: [
                  ...
                  OrderAmountCalculation(orderProvider: orderProvider,
                      itemTotalAmount: itemTotalAmount,discount: discount,
                      eeDiscount: eeDiscount,shippingCost: shippingCost, tax: tax,
                      referDiscount:referDiscount,brillDaddyDiscount:brillDaddyWalletDiscount),
