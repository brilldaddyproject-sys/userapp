                        ...
                        SizedBox(width: 80,
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index){
                                  print(compareProvider.attributeList?[index].name);
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            InkWell(onTap: ()=> Provider.of<CompareController>(context, listen: false).addCompareList(product!.id!),
              child: Row(mainAxisAlignment: MainAxisAlignment.end,children: [
                Icon(Icons.clear, color: Theme.of(context).primaryColor, size: 20,)]),),
                  ...
                  SizedBox(width: 200,
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index){
                            ...
                            ): Center(child: SizedBox(height: 48,width: 200,child: Center(child: Text('No Size', style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color),))));
                          })),
