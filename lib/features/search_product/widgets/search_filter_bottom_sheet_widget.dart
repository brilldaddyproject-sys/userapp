...
class SearchFilterBottomSheetState extends State<SearchFilterBottomSheet> {
  ...
  var endRangeValues = 0.0;
   IndicatorRangeSliderThumbShape<double> indicatorRangeSliderThumbShape = IndicatorRangeSliderThumbShape(0, 0);
 @override
  void initState() {
    currentRangeValues = RangeValues(0, Provider.of<SearchProductController>(context, listen: false).maxFilterValue,);
    endRangeValues = Provider.of<SearchProductController>(context, listen: false).maxFilterValue;
                        ...
                        child: Row(children: [
                          SizedBox(width: 120, child: CustomButton(backgroundColor: Theme.of(context).colorScheme.tertiaryContainer.withValues(alpha:.5),
                              ...
                              onTap: () {
                                ...
                                searchProvider.cleanSearchProduct(context);
