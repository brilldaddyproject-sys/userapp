          ...
          return Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () {
                    _showImageSourceActionDialog(context, refundReq);
                  },
...
void _showImageSourceActionDialog(BuildContext context, refundReq) {
  showDialog(
    context: context,
        ...
        children: [
          ListTile(
            ...
            onTap: () {
              ...
              refundReq.pickCamera(false); // Call the camera method
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              refundReq.pickImage(false); // Call the gallery method
            },
          ),
        ],
      ),
