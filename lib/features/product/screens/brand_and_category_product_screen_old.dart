...
class BrandAndCategoryProductScreenOld extends StatefulWidget {
  final bool isBrand;
  final int? id;
  final String? name;
  final String? image;
  ...
  const BrandAndCategoryProductScreenOld({
    super.key,
  ...
  @override
  State<BrandAndCategoryProductScreenOld> createState() => _BrandAndCategoryProductScreenState();
}

class _BrandAndCategoryProductScreenState extends State<BrandAndCategoryProductScreenOld> {
