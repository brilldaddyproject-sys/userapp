  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => OrderDetailsScreen(orderId: orderModel!.id)));},
      ...
      child: Stack(children: [
                    ...
                    Container(decoration: BoxDecoration(color: Theme.of(context).cardColor,
                      ...
                      child: ClipRRect(
                        ...
                        child: CustomImageWidget(
                          ...
                          image: '${orderModel?.details![0].product?.thumbnailFullUrl?.path}',
                          )),),]),),
                ...
                Expanded(flex: 5,
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(PriceConverter.convertPrice(context, orderModel!.orderType == 'POS' ? orderAmount : (orderModel!.orderAmount! - orderModel!.referralDiscount! - orderModel!.brilldaddyWalletDiscount!)),
        ...
        Positioned(bottom: 20, left: Provider.of<LocalizationController>(context, listen: false).isLtr? 90 : MediaQuery.of(context).size.width-50, child: Container(
          height: 22,
          width: 22,
