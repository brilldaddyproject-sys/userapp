...
class CartRepository extends DataSyncService implements CartRepositoryInterface {
  ...
  @override
  Future  getReferralData() async {
    try {
      final response = await dioClient.get('${AppConstants.checkrefferaldiscount}');
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  @override
  Future getBrillDaddyWalletAmount() async{
    try {
      final response = await dioClient.get('${AppConstants.checkbrilldadywalletbalance}');
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future deleteAllCart() async{
    try {
      final response = await dioClient.delete(AppConstants.removeFromCartUriAll);
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
