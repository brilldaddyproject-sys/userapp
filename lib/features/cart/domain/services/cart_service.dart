...
class CartService implements CartServiceInterface{
  ...
  @override
  Future<ApiResponseModel<T>> getReferralData<T>() async {
    return await cartRepositoryInterface.getReferralData();
  }

  @override
  Future<ApiResponseModel<T>> getBrillDaddyWalletAmount<T>() async{
    return await cartRepositoryInterface.getBrillDaddyWalletAmount();
  }

  @override
  Future deleteAllCart() async{
    return await cartRepositoryInterface.deleteAllCart();
  }
