    ...
    await Provider.of<CartController>(Get.context!, listen: false).getCartData(Get.context!);
     Provider.of<CartController>(Get.context!, listen: false).setCartData();
      if( Provider.of<SplashController>(Get.context!,listen: false).configModel!.shippingMethod != 'sellerwise_shipping'){
        await Provider.of<ShippingController>(Get.context!, listen: false).getAdminShippingMethodList(Get.context!).then((e){
          Provider.of<ShippingController>(context, listen: false).setSelectedShippingMethod(1, 1);
        });
      }
  }
                  ...
                  builder: (context, configProvider,_) {
                    ...
                    return Padding(
                      ...
                      child: Container(
                          ...
                          height: cartList.isNotEmpty ? 70 : 0, padding: const EdgeInsets.symmetric(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Clear Cart',
                              style: textBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).colorScheme.onSurface),
                            ),
                          ],
                        ),
                      ),
                                            ...
                                            child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                                                child: Row(
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Text("Select All", maxLines: 1, overflow: TextOverflow.ellipsis,
