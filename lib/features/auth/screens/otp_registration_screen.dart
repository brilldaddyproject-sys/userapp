                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        const Directionality(
                          ...
                          child: CustomAssetImageWidget(
                            Images.logoImage, height: 140,width: 200, fit: BoxFit.fitWidth,
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: Column(
                             ...
                             /* const SizedBox(height: Dimensions.paddingSizeLarge),
                              Text("Referral Code (optional)",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey),),
                              SizedBox(height: 10,),
                              CustomTextFieldWidget(
                                //hintText: getTranslated('demo_gmail', context),
                                isShowBorder: true,
                                ...
                                builder: (context, authProvider, child) {
                                  return CustomButton(
                                    ...
                                    onTap: (){
                                      ...
                                      String referCode = _referController!.text.trim();
                                      ...
                                      if (_nameController!.text.isEmpty) {
                                        ...
                                        if(isNumber){
                                          authProvider.registerWithOtp(name, email: email, phone: widget.userInput,referCode: referCode).then((value){
                                            if(value.isSuccess) {
