                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                padding: const EdgeInsets.all(16), // Inner p
                                child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                  widget.fromDigitalProduct? CustomAppBar(title: '${getTranslated('verify_otp', context)}'): const SizedBox(),

                                  SizedBox(height: 10,),
                                  Text("Otp",style: TextStyle(fontWeight: FontWeight.w700,color: Colors.black87,fontSize: 32),),
                                  SizedBox(height: 0,),
                                 ...
                                 // const SizedBox(height: Dimensions.paddingSizeExtraOverLarge),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      Text(getTranslated('i_didnt_receive_the_code', context)!,style: TextStyle(fontSize: 12),),
                                       ...
                                       InkWell(
                                          onTap: () async {
                                            ...
                                            if (widget.fromPage != FromPage.forgetPassword) {
                                              print("321");
                                              await authProvider.reSendVerificationCode(config,
                                                  SignUpModel(
                                          ...
                                          child: authProvider.resendButtonLoading ? Container(height: 20,width: 20,child: CircularProgressIndicator()) : Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
