...
class AuthService implements AuthServiceInterface{
  ...
  @override
  Future registerWithOtp(String name, {String? email, required String phone,required String referCode}) {
    return authRepoInterface.registerWithOtp(name, email: email, phone: phone,referCode: referCode);
  }
