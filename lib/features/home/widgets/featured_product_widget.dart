...
class FeaturedProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Selector<ProductController, ProductModel?>(
      ...
      return (featuredProductModel?.products?.isNotEmpty ?? false)  ? Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/feature-bg.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Padding(
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color:  Colors.black26, // Blue colcolor
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(getTranslated('featured_products', context)!,
