...
class OnBoardingScreen extends StatelessWidget {
  ...
  var dataList = ["Get started with brilldaddy and enjoy exclusive benefits!","Pay with confidence.Our payment system is fully encrypted and secure",
  "Pay with confidence.Our payment system is fully encrypted and secure."];
  @override
          ...
          return Stack(clipBehavior: Clip.none, children: [
              ...
              Consumer<OnBoardingController>(
                builder: (context, onBoardingList, child) => ListView(children: [
                  ...
                  onBoardingList.selectedIndex == 2 - 1?
