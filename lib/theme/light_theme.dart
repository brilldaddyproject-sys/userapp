...
Color _primaryColor = const Color(0xFF0051AD);
Color _secondaryColor = const Color(0xFF0051AD);


ThemeData light({Color? primaryColor, Color? secondaryColor,fontFamily})=> ThemeData(
  fontFamily: fontFamily,
  primaryColor: primaryColor ?? const Color(0xFF0051AD),
  ...
  colorScheme:  ColorScheme.light(
    ...
    tertiary: const Color(0xFF0051AD), // Warning Color
