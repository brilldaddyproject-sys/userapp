...
class AppConstants {
  static const String appName = 'Brilldaddy';
  static const String slogan = 'E-Commerce Marketplace';
  static const String appVersion = '1.0.24'; ///Flutter SDK 3.29.3
  static const LocalCachesTypeEnum cachesType = LocalCachesTypeEnum.all;

  //new api's
  static const String vouchersUri = '/api/v1/listvoucher';
  static const String listvoucherwinner = '/api/v1/listvoucherwinner';
  ...
  static const String removeWishListAllUri = '/api/v1/customer/wish-list/removeall';
  ...
  static const String removeFromCartUriAll = '/api/v1/cart/remove-all';
  ...
  static const List<String> walletEarnTypeList = [
    'voucher_payment','add_fund_by_admin', 'loyalty_point', 'order_place', 'order_refund', 'added_via_payment_method', 'earned_by_referral'
  ];
