        ...
        child: Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: Colors.grey.shade200, // Blue color
              borderRadius: BorderRadius.circular(10), // Fully rounded capsule
            ),
                       ...
                       children: [
                           ...
                           children: [
                             Text(
                               ...
                               style: robotoBold.copyWith(color: Theme.of(context).primaryColor,fontSize: 14),
                             ),
